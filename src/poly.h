...
/* "mutate motivically": double the reduced part and add the exteriors, set exteriors to zero */
...
typedef struct polyType {
    ...
    void (*motate)(void *self);  /* "motivic mutation" */
    void (*etatom)(void *self);  /* "inverse motivic mutation" */
